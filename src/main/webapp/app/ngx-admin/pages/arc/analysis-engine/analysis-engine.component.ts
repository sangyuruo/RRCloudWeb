...
@Component({
    ...
    templateUrl: './analysis-engine.component.html',
    styles: [`
    nb-card {
...
export class AnalysisEngineComponent {
    ...
    constructor(private service: ArcService,
        ...
        this.source = new ServerDataSource(http, { endPoint: '/emcloudarc/api/analysis-engines' },
        dateUtils
        );
    }
