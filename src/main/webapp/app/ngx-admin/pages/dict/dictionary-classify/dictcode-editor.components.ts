...
@Component({
    template: `
        ...
        <option *ngFor="let dictionaryClassify of dictionaryClassifies" [value]="dictionaryClassify.dictCode">{{dictionaryClassify.dictCode}}</option>
        </select>
     
  `,

})
export class DictCodeEditorComponent extends DefaultEditor implements AfterViewInit {
