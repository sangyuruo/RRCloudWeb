...
@Component({
    template: `
        ...
        <option *ngFor="let multiwaySwitch of multiwaySwitchs" [value]="multiwaySwitch.meterCode">{{multiwaySwitch.meterCode}}</option>
        </select>
     
  `,

})
export class MsiMeterCodeEditorComponent extends DefaultEditor implements AfterViewInit {
