        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.resourceService.find(id).subscribe((resource) => {
                    resource.createTime = this.datePipe
                        .transform(resource.createTime, 'yyyy-MM-ddTHH:mm:ss');
                    resource.updateTime = this.datePipe
                        .transform(resource.updateTime, 'yyyy-MM-ddTHH:mm:ss');
